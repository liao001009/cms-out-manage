...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const handleEdit = useCallback(() => {
    history.goto(`/cmsSupplierPostPrice/edit/${data.fdId}`)
  }, [history])
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.manage.core.entity.supplier.CmsSupplierPostPrice'}&fdType=${'normal'}&fdEntityCode=${'cms-supplier'}`
    history.goto(`/cmsSupplierPostPrice/print/${data.fdId}${params}`)
  }, [history])
