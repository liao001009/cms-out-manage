...
// import AddComponent from '@/manage/pages/cmsSupplierPostPriceTemplate/baseList'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  } = useAdd('/cmsSupplierPostPrice/add')
        ...
        <div className="lui-template-list-toolbar">
          ...
          <div className="right">
            <Space>
              ...
              <React.Fragment>
                <Auth.Auth
                  authURL='/cmsSupplierPostPrice/add'
                ...
                <Auth.Auth
                  authURL='/cmsSupplierPostPrice/delete'
                  authModuleName='cms-out-manage'
                  unauthorizedPage={null}
                >
