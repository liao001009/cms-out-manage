...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const handleEdit = useCallback(() => {
    history.goto(`/cmsSupplierEvaluate/edit/${data.fdId}`)
  }, [history])
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.manage.core.entity.supplier.CmsSupplierEvaluate'}&fdType=${'normal'}&fdEntityCode=${'cms-supplier'}`
    history.goto(`/cmsSupplierEvaluate/print/${data.fdId}${params}`)
  }, [history])

  return (
    <Auth.Auth
      authURL='/cmsSupplierEvaluate/get'
