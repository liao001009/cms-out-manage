...
import { useApi, useSystem } from '@/desktop/staff-shared/formHooks'
import XformAppearance from '@/desktop/components/staff/form/XformAppearance'
import LayoutGrid from '@/desktop/components/staff/form/LayoutGrid'
import GridItem from '@/desktop/components/staff/form/GridItem'
import XformDescription from '@/desktop/components/staff/form/XformDescription'
import XformFieldset from '@/desktop/components/staff/form/XformFieldset'
import XformInput from '@/desktop/components/staff/form/XformInput'
import XformAddress from '@/desktop/components/staff/form/XformAddress'
import XformDatetime from '@/desktop/components/staff/form/XformDatetime'
import XformSelect from '@/desktop/components/staff/form/XformSelect'
import XformRadio from '@/desktop/components/staff/form/XformRadio'
import XformCheckbox from '@/desktop/components/staff/form/XformCheckbox'
import XformDetailTable from '@/desktop/components/staff/form/XformDetailTable'
import CMSXformModal, { EShowStatus } from '@/desktop/components/staff/form/cms/XformModal'
import CMSXformRelation from '@/desktop/components/staff/form/cms/XformRelation'
...
const XForm = (props) => {
  ...
  const [projectNatureVis, setProjectNatureVis] = useState<string>('0')
  const [stationVis, setStationVis] = useState<string>('2')
