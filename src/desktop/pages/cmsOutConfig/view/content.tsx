...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const handleEdit = useCallback(() => {
    history.goto(`/cmsOutConfig/edit/${data.fdId}`)
  }, [history])
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.order.core.entity.CmsOutConfig'}&fdType=${'normal'}&fdEntityCode=${'cms-workorder'}`
    history.goto(`/cmsOutConfig/print/${data.fdId}${params}`)
  }, [history])
