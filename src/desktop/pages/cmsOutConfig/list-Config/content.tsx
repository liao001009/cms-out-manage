...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        title: '工位地点(深圳)',
        dataIndex: 'fdStationSz',
        render: (value) => value && value.fdName
      },
      /*工位地点(武汉)*/
      {
        title: '工位地点(武汉)',
        dataIndex: 'fdStationWh',
        render: (value) => value && value.fdName
      },
      /*云主机*/
      {
        title: '云主机',
        dataIndex: 'fdCloudHost',
        render: (value) => value && value.fdName
      },
      /*码云*/
      {
      ...
      {
        title: '门禁(深圳)',
        dataIndex: 'fdEntranceGuardSz',
        render: (value) => value && value.fdName
      },
      /*门禁(武汉)*/
      {
        title: '门禁(武汉)',
        dataIndex: 'fdEntranceGuardWh',
        render: (value) => value && value.fdName
      },
      /*网络权限*/
      {
        title: '网络权限',
        dataIndex: 'fdNetworkPrem',
        render: (value) => value && value.fdName
      }
    ],
    []
  ...
  //新建
  const { $add: $add } = useAdd('/cmsOutConfig/add')
  ...
  const onRowClick = useCallback(
    (record) => {
      return {
        onClick: () => {
          history.goto(`/cmsOutConfig/view/${record.fdId}`)
        }
      }
    },
    [history]
