...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const handleEdit = useCallback(() => {
    history.goto(`/cmsContractInfo/edit/${data.fdId}`)
  }, [history])
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.manage.core.entity.supplier.CmsContractInfo'}&fdType=${'normal'}&fdEntityCode=${'cms-supplier'}`
    history.goto(`/cmsContractInfo/print/${data.fdId}${params}`)
  }, [history])

  return (
    <Auth.Auth
      authURL='/supplier/cmsContractInfo/get'
