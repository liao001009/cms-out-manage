...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.order.core.entity.CmsOutOrder'}&fdType=${'normal'}&fdEntityCode=${'cms-workorder'}`
    history.goto(`/cmsOutOrder/print/${data.fdId}${params}`)
  }, [history])
