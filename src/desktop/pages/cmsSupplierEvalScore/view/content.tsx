...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const handleEdit = useCallback(() => {
    history.goto(`/cmsSupplierEvalScore/edit/${data.fdId}`)
  }, [history])
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.manage.core.entity.supplier.CmsSupplierEvalScore'}&fdType=${'normal'}&fdEntityCode=${'cms-supplier'}`
    history.goto(`/cmsSupplierEvalScore/print/${data.fdId}${params}`)
  }, [history])

  return (
    <Auth.Auth
      authURL='/supplier/cmsSupplierEvalScore/get'
