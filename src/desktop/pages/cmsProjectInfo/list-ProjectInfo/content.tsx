...
import { $reduceCriteria } from '@/desktop/project-shared/criteria'
import Operation from '@elem/operation'
import Table, { useTable } from '@elem/mk-table'
import api from '@/api/cmsProjectInfo'
import { useAdd } from '@/desktop/project-shared/add'
import { $deleteAll } from '@/desktop/project-shared/deleteAll'
