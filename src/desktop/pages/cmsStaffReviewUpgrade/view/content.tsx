...
import { Module, Auth } from '@ekp-infra/common'
...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const handleEdit = useCallback(() => {
    history.goto(`/cmsStaffReviewUpgrade/edit/${data.fdId}`)
  }, [history])
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.manage.core.entity.supplier.CmsStaffReviewUpgrade'}&fdType=${'normal'}&fdEntityCode=${'cms-supplier'}`
    history.goto(`/cmsStaffReviewUpgrade/print/${data.fdId}${params}`)
  }, [history])

  return (
    <Auth.Auth
      authURL='/supplier/cmsStaffReviewUpgrade/get'
