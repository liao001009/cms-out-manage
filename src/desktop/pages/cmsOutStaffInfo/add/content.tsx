...
import XForm from './form/index'
// import ContentTest from './form'
  ...
  return (
    <div className='lui-approve-template'>
      ...
      <div className='lui-approve-template-content'>
        {/* 表单信息 */}
        <div className='form'>
          <XForm formRef={formComponentRef} value={data || {}} queryChange={props.queryChange} history={history} query={props.query}/>
          {/* <ContentTest /> */}
        </div>
      </div>
    </div>
