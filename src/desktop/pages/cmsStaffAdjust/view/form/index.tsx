...
import XformAttach from '@/desktop/components/staff/form/XformAttach'
...
const XForm = (props) => {
  ...
  const baseCls = 'lui-xform'
  return (
    <div className={`${baseCls} view-form`}>
      <Form form={form} colPadding={false} onValuesChange={onValuesChange}>
        <XformAppearance>
          <LayoutGrid columns={2} rows={22}>
            ...
            {
              value.fdAdjustReason === '2' ? null : <Fragment>
