...
import List from '@/mobile/components/supplier/list'
import ItemRender from '@/mobile/components/supplier/item'
import api from '@/api/cmsSupplierPostPrice'
import Sorter from '@/mobile/components/supplier/sorter'
import { useAdd } from '@/mobile/supplier-shared/add'
import AddComponent from '@/mobile/pages/cmsSupplierPostPriceTemplate/baseList'
import './index.scss'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  } = useAdd('/cmsSupplierPostPrice/add/!{selectedRow}')
  ...
  const handleRowClick = useCallback((record) => {
    history.goto(`/cmsSupplierPostPrice/view/${record.fdId}`)
  }, [])
