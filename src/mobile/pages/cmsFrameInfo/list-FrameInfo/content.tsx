...
import List from '@/mobile/components/base-data/list'
import ItemRender from '@/mobile/components/base-data/item'
import api from '@/api/cmsFrameInfo'
import Sorter from '@/mobile/components/base-data/sorter'
import { useAdd } from '@/mobile/base-data-shared/add'
import AddComponent from '@/mobile/pages/cmsFrameInfoTemplate/baseList'
import './index.scss'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  //新建
  const { $add: $add, $addClose: $addClose, $addVisible: $addVisible } = useAdd('/cmsFrameInfo/add/!{selectedRow}')
  ...
  const handleRowClick = useCallback((record) => {
    history.goto(`/cmsFrameInfo/view/${record.fdId}`)
  }, [])
