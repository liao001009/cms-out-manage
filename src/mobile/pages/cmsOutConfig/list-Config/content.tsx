...
import AddComponent from '@/mobile/pages/cmsOutConfigTemplate/baseList'
import './index.scss'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  //新建
  const { $add: $add, $addClose: $addClose, $addVisible: $addVisible } = useAdd('/cmsOutConfig/add/!{selectedRow}')
